...
public class EmailService {
	...
	private void sendEmail(String email, String code) {
		...
		String htmlContent = """
			...
			<body style="margin: 0; padding: 20px; background-color: #f9f9f9; font-family: 'Apple SD Gothic Neo', sans-serif;">
			  <table role="presentation" width="100%%" cellpadding="0" cellspacing="0" style="max-width: 500px; margin: auto; background-color: #ffffff; border: 1px solid #ddd; border-radius: 10px;">
			    <tr>
			      <td style="padding: 30px; text-align: center;">
			        ...
			        <div style="margin: 30px auto; padding: 20px; background-color: #f0f8ff; border-radius: 8px; border: 2px #4a90e2; display: inline-block;">
